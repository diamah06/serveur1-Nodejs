...
// //  //res.json({ message: " post word" });
//  // res.json({ message:req.body.value});
// //});

// /* PUT */
// //router.put('/', function(req, res, next) {
//  // res.json({ message: "update hello, word" });
// //});

// /* DELETE */
// //router.delete('/', function(req, res, next) {
//  // res.json({ message: "delete hello, word" });
// //});

// // tester sur postamn : http://localhost:3000/api/reservations
